...
\end{equation*}
Notar que la última inversa a calcular en \eqref{eq:feedforward} es en realidad una pseudoinversa de una matriz rectangular, por lo que el controlador no será capaz de controlar en función de ambas referencias en forma simultánea.
...
\subsubitem{Verificación}

Para la verificación del funcionamiento del controlador con acción integral, se introdujo una sucesión de referencias tipo escalón, y se midieron las variables de estado observadas. El resultado fue comparado con una simulación.
...
\begin{figure}[!htbp]
	...
	\begin{subfigure}{0.49\linewidth}
		...
		\caption{Ángulo de la barra.}
		\label{fig:int-theta-new}
	\end{subfigure}
	\begin{subfigure}{0.49\linewidth}
		\centering
		\includegraphics[width=\linewidth]{int-pos.eps}
		\caption{Posición del carrito.}
		\label{fig:int-pos-new}
	\end{subfigure}
