...
void loop() {
  ...
  // BACKWARDS
  //const float k_p = -100;
  //const float k_i = -50.0;
  //const float k_d = -2;

  const float k_p = -80.0;
  const float k_i = -45.0;
  const float k_d = -.05; // es subible una vez se prefiltren los datos


  static float ang = 0;
  static float e_1 = 0.0;
  static float e_acum = 0.0;
  static float u = 0.0;
  ...
  // BACKWARDS
  // e_acum += DT*e;
  // u = k_p * e + e_acum * k_i + (e - e_1)*k_d/DT;
  // e_1 = e;
